 ...
 * Uses the same Groq API key as the trading agent.
 */

import OpenAI from "openai";

/**
 * Analyze crypto sentiment for tokens using Groq.
...
Consider:
- The token's community size and activity level
- Recent market performance and how communities typically react
- Known catalysts, partnerships, or upcoming events
- General meme token market sentiment`,
        },
        {
          role: "user",
